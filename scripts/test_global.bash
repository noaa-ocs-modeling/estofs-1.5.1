...
export logFile=${platform}"/gpfs/hps3/nos/noscrub/polar/estofs_global/estofs_post.log"
...
export outputDir=${platform}"/gpfs/hps3/nos/noscrub/polar/estofs_global/"
export tmpDir=${platform}"/gpfs/hps3/nos/noscrub/tmp/estofs_global/"
export pltCfgFile=${platform}"/gpfs/hps3/nos/noscrub/nwprod/estofs-1.5.1/scripts/config.plot.estofs.global.ini"

export ftpLogin="svinogradov@emcrzdm"
export ftpPath="/home/www/polar/estofs/global/"
